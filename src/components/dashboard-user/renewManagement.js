...
import Datatable from '../dashboard/leads/datatable/Datatable'
import TableReport from '../dashboard/reporting/react-table-reporting'
import Reporting from '../dashboard/reporting/reporting'
import TableReporting from '../dashboard/reporting/table-reporting'

function RenewManagement() {
...
export default RenewManagement
