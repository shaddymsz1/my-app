...
import { MENUITEMS } from '../../../constant/menuUser';
import { MainSideBarMenu } from '../../../constant/user-sidebar-menu';
            ...
            <div className="page-sidebar">
                ...
                <div className="sidebar custom-scrollbar">
                    ...
                    >
                        ...
                        {
                            MainSideBarMenu.map((menuItem, i) =>
...
export default translate(SidebarUser);
