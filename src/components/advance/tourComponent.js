...
const TourComponent = () => {
    ...
    const steps = [ 
        ...
        {
            selector: '.firstPost',
            content: 'This is you first post'
        }
        // ...
    ]
    return (
        <Fragment>
            <Breadcrumb title="Tour" parent="Advance" />
            <Tour
                steps={steps}
                isOpen={isTourOpen}
                rounded={5}
                                ...
                                <div className="user-image ">
                                    ...
                                    <div className="icon-wrapper">
                                        <i className="icofont icofont-pencil-alt-5" data-intro="Change Profile image here" >
                                            <input className="pencil" type="file" onClick={(e) => readUrl(e)} />
                                        </i>
                                    </div>
                                </div>
                                    ...
                                    <div className="row detail" data-intro="This is the your details">
                                        ...
                                        <div className="col-sm-12 col-lg-4 order-sm-0 order-xl-1">
                                            <div className="user-designation">
                                                <div className="title"><a target="_blank" href="javascript">Mark jecno</a></div>
                                            ...
                                            <div className="row">
                                                <div className="col-md-6">
                                                    <div className="ttl-info text-left ttl-xs-mt">
                                                        <h6><i className="fa fa-phone"></i>   Contact Us</h6><span>India +91 123-456-7890</span>
                                                    </div>
                                                </div>
                                                <div className="col-md-6">
                                                    <div className="ttl-info text-left ttl-sm-mb-0">
                            ...
                            <div className="card">
                                <div className="profile-img-style">
                                    <div className="row">
                                        <div className="col-sm-8">
                                            <div className="media">
                                                <img className="img-thumbnail rounded-circle mr-3" src={url ? url : seven} alt="Generic placeholder" />
                                                <div className="media-body align-self-center">
                                                    <h5 className="mt-0 user-name">JOHAN DIO</h5>
                                                </div>
                                            </div>
