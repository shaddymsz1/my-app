                                ...
                                <div className="col-xl-4 xl-40 col-lg-6 col-md-5">
                                    <div className="row">
                                            ...
                                            <div className="card card-mb-faq">
                                                ...
                                                <div className="card-body faq-body">
                                                    <div className="navigation-btn"><a className="btn btn-primary" href="#javascript">
                                                        <MessageSquare className="m-r-10" />Ask Question</a></div>
                                                    <div className="navigation-option">
                                                        <ul>
                                                            <li><a href="#javascript"><Edit />Tutorials</a></li>
                                                            <li><a href="#javascript"><Globe />Help center</a></li>
                                                            ...
                                                            <li><a href="#javascript"><Youtube />Video Tutorials</a><span className="badge badge-primary badge-pill pull-right">648</span></li>
                                                            <li><a href="#javascript"><MessageCircle />Ask our community</a></li>
                                                            <li><a href="#javascript"><Mail />Contact us</a></li>
                                                        </ul>
                                                        <hr />
                                                        <ul>
                                                            <li><a href="#javascript"><MessageCircle />Ask our community</a></li>
                                        ...
                                        <div className="col-lg-12">
                                            <div className="card">
                                                <div className="card-header faq-header">
                                                    <h5 className="d-inline-block">Latest Updates</h5><span className="pull-right d-inline-block">See All</span>
                                                </div>
                                                <div className="card-body faq-body">
                                                    <div className="media updates-faq-main">
                                                        ...
                                                        <div className="media-body updates-bottom-time">
                                                            <p><a href="#javascript">David Linner </a>requested money back for a double debit card charge</p>
                                                            <p>10 minutes ago</p>
                                                        </div>
                                                    </div>
                                                    <div className="media updates-faq-main">
                                                    ...
                                                    <div className="media updates-faq-main">
                                                        ...
                                                        <div className="media-body updates-bottom-time">
                                                            <p>User Christopher <a href="#javascript">Wallace</a> is on hold and awaiting for staff reply</p>
                                                            <p>45 minutes ago</p>
                                                        </div>
                                                    </div>
                                                    <div className="media updates-faq-main">
                                                        ...
                                                        <div className="media-body updates-bottom-time">
                                                            <p>Ticket #43683 has been closed by <a href="#javascript">Victoria Wilson</a></p>
                                                            <p>Dec 7, 11:48</p>
                                                        </div>
                                                    </div>
                                                </div>
