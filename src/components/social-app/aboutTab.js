                                        ...
                                        <ul>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <img className="img-60 img-fluid rounded-circle" alt="twoImg" src={two} /><span className="d-block f-w-600">Jason Borne</span>
                                                    <button className="btn btn-primary btn-xs">Add Friend</button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <img className="img-60 img-fluid rounded-circle" alt="threeImg" src={three} /><span className="d-block f-w-600">Anna Mull</span>
                                                    <button className="btn btn-primary btn-xs">Add Friend</button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <img className="img-60 img-fluid rounded-circle" alt="threeImg" src={three} /><span className="d-block f-w-600">Dion Cast</span>
                                                    <button className="btn btn-primary btn-xs">Add Friend</button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <img className="img-60 img-fluid rounded-circle" alt="four" src={four} /><span className="d-block f-w-600">Karlene Lex</span>
                                                    <button className="btn btn-primary btn-xs">Add Friend</button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <img className="img-60 img-fluid rounded-circle" alt="eightImg" src={eight} /><span className="d-block f-w-600">Vella Chism</span>
                                                    <button className="btn btn-primary btn-xs">Add Friend</button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <img className="img-60 img-fluid rounded-circle" alt="tenImg" src={ten} /><span className="d-block f-w-600">Wai Schalk</span>
                                                    <button className="btn btn-primary btn-xs">Add Friend</button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <img className="img-60 img-fluid rounded-circle" alt="" src={fourteen} /><span className="d-block f-w-600">Karlene Lex</span>
                                                    <button className="btn btn-primary btn-xs">Add Friend</button>
                                                </div>
                                            </li>
                                        </ul>
                                        ...
                                        <ul>
                                            ...
                                            <li>
                                                <div className="add-friend text-center">
                                                    ...
                                                    <span className="d-block f-w-600">Anna Mull</span>
                                                    <button className="btn btn-primary btn-xs">Add Friend</button>
                                                </div>
                                            </li>
                                            <li>
                                                <div className="add-friend text-center">
                                                    <img className="img-60 img-fluid rounded-circle" alt="" src={three} />
                                                    <span className="d-block f-w-600">Dion Cast</span>
                                                    <button className="btn btn-primary btn-xs">Add Friend</button>
                                                </div>
                                            </li>
                                            <li>
