...
import { bitcoinChartOptions, bitcoinChartData, tradingChartData, tradingChartOptions, ethereumChartData, ethereumChartOptions, marketChartData, marketChartOption, salesChartData, salesChartOptions, doughnutData, doughnutOptions } from '../../../charts-data/default';
            ...
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className="col-xl-4 xl-100">
                        <div className="card">
                            <div className="card-header b-l-primary"><h5>Market Value</h5></div>
                            <div className="card-body">
                                        ...
                                        <div className="col-xl-4 mb-3 col-sm-3">
                                            ...
                                            <div className="bitcoin-form-dropdown">
                                                <div className="onhover-dropdown">
                                                    ...
                                                    <div className="onhover-show-div"><a className="d-block" href="#javascript">Link 1</a><a className="d-block" href="#javascript">Link 2</a><a className="d-block" href="#javascript">Link 3</a></div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="card-body">
                                <div className="bitcoin-form">
                                    <div className="form-row">
                                        ...
                                        <div className="col-md-12">
                                            <div className="btn-bottom">
                                                <button className="btn btn-primary" type="button">Sell Now!</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <div className="message my-message">
                                                        ...
                                                        Project has been already finished and
                                                ...
                                                <li className="clearfix">
                                                    <div className="message other-message pull-right">
                                                        ...
                                                        Well I am not sure. The rest of the
                                                ...
                                                <li>
                                                    <div className="message my-message mb-0">
                                                        ...
                                                        Actually everything was fine. I'm very
                            ...
                            <div className="card-body chart-block">
                                <div className="pull-right right-header invest-dropdown">
                                    <div className="onhover-dropdown">
                                        ...
                                        <div className="onhover-show-div right-header-dropdown"><a className="d-block" href="#javascript">Link 1</a><a className="d-block" href="#javascript">Link 2</a><a className="d-block" href="#javascript">Link 3</a></div>
                                    </div>
                                </div>
