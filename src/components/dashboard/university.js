                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div className="professor-block d-inline-block">luson keter
                                                                    <p>Math Professors</p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <div className="professor-block d-inline-block">Elan hormas
                                                                    <p>Bio Professors</p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><img className="img-radius img-25 align-top m-r-15 rounded-circle" src={bio1} alt="" />
                                                            <div className="professor-block d-inline-block">Erana siddy
                                                                     <p>Director</p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td><img className="img-radius img-35 align-top m-r-15 rounded-circle" src={bio2} alt="" />
                                                            <div className="professor-block d-inline-block">Tom kerrly
                                                                     <p>Director</p>
                                                            </div>
                                                        </td>
                                                        <td>
                            ...
                            <div className="card-body">
                                <div className="upcoming-event">
                                    <div className="upcoming-innner media">
                                        ...
                                        <div className="media-body">
                                            <p className="mb-0">Demo Content <span className="pull-right">Mar 18</span></p>
                                    ...
                                    <div className="upcoming-innner media">
                                        ...
                                        <div className="media-body">
                                            <p className="mb-0">Demo Content <span className="pull-right">Sep 18</span></p>
                                    ...
                                    <div className="upcoming-innner media">
                                        ...
                                        <div className="media-body">
                                            <p className="mb-0">Demo Content <span className="pull-right">Dec 18</span></p>
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-inline-block align-self-center">
                                                        ...
                                                        <div className="d-inline-block"><span className="f-w-600">Ossim Keter</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-inline-block align-self-center">
                                                        ...
                                                        <div className="d-inline-block"><span className="f-w-600">Fran Loain</span>
                                                            <p>1<sup>st</sup> year</p>
                                                        </div>
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div className="d-inline-block align-self-center">
                                                        ...
                                                        <div className="d-inline-block"><span className="f-w-600">Loften Horen</span>
                                                            <p>1<sup>st</sup> year</p>
                                                        </div>
                                                    </div>
                                                </td>
