            ...
            <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-xl-4 col-md-6 xl-50">
                            <div className="card">
                                <div className="card-header">
                                    <h5>Total Profit</h5><span className="d-block fonts-dashboard">All Custom Income</span>
                                </div>
                                <div className="card-body">
                                    ...
                                    <div className="show-value d-flex">
                                        <div className="value-left">
                                            <div className="square bg-primary d-inline-block"></div><span>Total Profit</span>
                                        </div>
                                        <div className="value-right">
                                            <div className="square bg-light d-inline-block"></div><span>Total Investment</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="col-md-12">
                                    <div className="card">
                                        <div className="card-body progress-media">
                                            <div className="media">
                                                <div className="media-body">
                                                    <h5>Total Review</h5><span className="mb-0 d-block">Customer Review</span>
                                                </div>
                                                <ThumbsUp />
                                            </div>
                                ...
                                <div className="col-md-12">
                                    <div className="card">
                                        <div className="card-body progress-media">
                                            <div className="media">
                                                <div className="media-body">
                                                    <h5>Total Feedback</h5><span className="mb-0 d-block">Feedback</span>
                                                </div>
                                                <MessageCircle />
                                            </div>
                                            <div className="progress-bar-showcase">
                                ...
                                <div className="card-body">
                                    <div className="show-value-top d-flex">
                                        <div className="value-left d-inline-block">
                                            <div className="square bg-primary d-inline-block"></div><span>Total Income</span>
                                        </div>
                                        <div className="value-right d-inline-block">
                                            <div className="square d-inline-block bg-smooth-chart"></div><span>Total Loss</span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-sm-6">
                                            <div className="pull-right right-header">
                                                <div className="onhover-dropdown">
                                                    <button className="btn btn-primary btn-pill" type="button">All <span className="pr-0"><i className="fa fa-angle-down"></i></span></button>
                                                    <div className="onhover-show-div right-header-dropdown"><a className="d-block" href="#javascript">Shipping</a><a className="d-block" href="#javascript">Purchase</a><a className="d-block" href="#javascript">Total Sell</a></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
