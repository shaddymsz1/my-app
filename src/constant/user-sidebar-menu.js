...
export const MainSideBarMenu = [
  ...
  },
  {
    ...
    children: [
      {
        path: "/userDashboard/sold-policies",
        title: "Sold",
        type: "link",
      },
      {
        path: "/userDashboard/saved-policies",
        title: "Saved Policies",
        type: "link",
      },
      {
        path: "/userDashboard/renewals",
        title: "Renewals",
        type: "link",
      },
      {
        path: "/userDashboard/endorsement",
        title: "Endorsement",
        type: "link",
      },
      {
        path: "/userDashboard/policy-reminder",
